...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        Object locations = new JsonSlurper().parse(new File(ProjectUtils.getCorrectPathOS("src\\main\\resources\\Locations.json")))
        locations.each{
        ...
        users.each{
            ...
            user.location = Location.get(it.locationId)
